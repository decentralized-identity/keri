...
Because fully qualified cryptographic material in KERI is fully parsable (self-framing) we may simply attach, after the receipt statement, a sequence of couplets of concatenated fully qualified Base64 representations of each witness identifier prefix and each witnesses signature.  
