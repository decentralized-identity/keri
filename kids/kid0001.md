...
|     M    | Tag Base64 string 3 characters, short value of length 16 bits                                     |      1      |              |       4      |
...
|    0E    | SHA3-512 Digest. Self-addressing derivation.                                                      |      2      |              |      88      |
|    0F    | Blake2b-512 Digest. Self-addressing derivation.                                                   |      2      |              |      88      |
|    0G    | SHA2-512 Digest. Self-addressing derivation.                                                      |      2      |              |      88      |
|    0H    | Big tag Base64 string 6 characters, long value of length 32 bits                                  |      2      |              |       8      |
...
|    C#    | String Base64 characters of variable length L=N*4-2 where L is value of index                     |      2      |       1      |   Variable   |
|          |                        **Indexed Four Character Codes**                                        |             |              |              |
|   0A##   | Ed448 indexed signature                                                                           |      4      |       2      |      156     |
|   0B##   | String Base64 quadlets of variable length L=N*4 where N is value of index                         |      4      |       2      |   Variable   |
