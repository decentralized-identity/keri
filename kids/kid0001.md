...
4) The length of the fully qualified primitive including code and append material or number of elements in group. 
5) The maximum index or count value for indexed or counter codes.
