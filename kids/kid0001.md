...
|    C#    | Short String Base64 chars of variable length L=N*4-S%4 where N is value of index S is code size   |      2      |       1      |   Variable   |
|          |                        **Indexed Four Character Codes**                                        |             |              |              |
|   0A##   | Ed448 indexed signature                                                                           |      4      |       2      |      156     |
|   0B##   | Long String Base64 chars of variable length L=N*4-S%4 where N is value of index S is code size    |      4      |       2      |   Variable   |
